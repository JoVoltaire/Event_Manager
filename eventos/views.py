...
def inscrever_evento(request, id):
    ...
    if request.method == 'GET':
       ...
       messages.add_message(request, constants.SUCCESS, 'Incrição realizada com sucesso')
...
def certificados_evento(request, id):
    ...
    if request.method == "GET":
        ...
        return render(request, 'certificados_evento.html', {'qtd_certificados': qtd_certificados, 'qtd_certificados': qtd_certificados, 'evento': evento})
